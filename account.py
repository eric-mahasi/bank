class Account(object):
    ...
    def __init__(
            self, account_name, account_id, deposit_amount,
            withdraw_amount, account_balance=1000):
    ...
    def withdraw(self):
        ...
        self.withdraw_amount = int(input(prompt))
    ...
    def deposit(self):
        ...
        self.deposit_amount = int(input(prompt))
